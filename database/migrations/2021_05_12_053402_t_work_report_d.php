...
class TWorkReportD extends Migration
{
    ...
    public function up()
    {
        Schema::create('t_work_report_d', function (Blueprint $table) {
            $table->string('work_report_no', 8)->require();
            $table->integer('work_report_detail_no')->require();
            $table->string('manufacture_no', 8)->require();
            $table->string('work_hour_div', 2)->require();
            $table->string('work_time_div', 2)->require();
