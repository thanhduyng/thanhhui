...
class SLibVal extends Migration
{
    ...
    public function up()
    {
        Schema::create('s_lib_val', function (Blueprint $table) {
            $table->string('lib_cd', 30)->require();
            $table->string('lib_val_cd', 10)->require();
            $table->string('lib_val_nm_j', 100)->require();
            $table->string('lib_val_ab_j', 50)->require();
            $table->string('lib_val_nm_e', 100)->require();
            $table->string('lib_val_ab_e', 50)->require();
